...
/**
 * Topic model with one single-component perspective factor for two views, and a
 * latent supertopic factor spanning both views as well.  Just concatenation of
 * factors defined in SpriteSupertopic and SpriteTopicPerspective.
 * 
 * @author adrianb
 *
 */
public class Sprite2ViewSupertopicAndPerspective extends SpriteFactoredTopicModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8356557959212672700L;
	
	public Sprite2ViewSupertopicAndPerspective(SpriteThetaPrior[] thetaPriors0,
	...
	public static void main(String[] args) {
		...
		if (p != null) {
			...
			topicModel = new Sprite2ViewSupertopicAndPerspective(graph._2(), graph._3(), graph._1(), p.numThreads, p.step);
