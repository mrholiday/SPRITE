 ...
 *
 */
public class Sprite5Supertopic extends SpriteFactoredTopicModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8356557959212672700L;
	
	public Sprite5Supertopic(SpriteThetaPrior[] thetaPriors0,
	...
	public static void main(String[] args) {
		...
		if (p != null) {
			...
			topicModel = new Sprite5Supertopic(graph._2(), graph._3(), graph._1(), p.numThreads, p.step);
