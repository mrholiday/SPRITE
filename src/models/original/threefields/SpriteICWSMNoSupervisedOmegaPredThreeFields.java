 ...
 */
public class SpriteICWSMNoSupervisedOmegaPredThreeFields extends TopicModel implements Serializable {
	...
	public SpriteICWSMNoSupervisedOmegaPredThreeFields(int z, double sigmaAlpha0, double sigmaA0, double sigmaAB0, double sigmaW0, double sigmaWB0,
