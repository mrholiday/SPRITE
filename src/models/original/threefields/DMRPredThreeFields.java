 ...
 */
public class DMRPredThreeFields extends TopicModel implements Serializable {
	/**
	 * 
	 */
...
//	double[][] adaOmega;
	...
	public DMRPredThreeFields(int z, double sigmaA0, double sigmaAB0, double sigmaW0, double sigmaWB0,
