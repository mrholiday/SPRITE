 ...
 */
public class SpriteICWSMNoSupervisedOmegaThreeFields extends TopicModel implements Serializable {
	...
	public SpriteICWSMNoSupervisedOmegaThreeFields(int z, double sigmaAlpha0, double sigmaA0, double sigmaAB0, double sigmaW0, double sigmaWB0,
