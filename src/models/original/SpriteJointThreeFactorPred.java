 ...
 */
public class SpriteJointThreeFactorPred extends TopicModel implements Serializable {
	/**
	 * 
	 */
	...
	public SpriteJointThreeFactorPred(int z, double sigmaA0, double sigmaAB0, double sigmaW0, double sigmaWB0,
