 ...
 */
public class SpriteJointThreeFactor extends TopicModel implements Serializable {
	/**
	 * 
	 */
	...
	public SpriteJointThreeFactor(int z, double sigmaA0, double sigmaAB0, double sigmaW0, double sigmaWB0,
